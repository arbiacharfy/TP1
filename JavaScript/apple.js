...
$(document).ready(function() {
	...
	for (var i = 0; i < descJsonObjects.length; i++) {
		...
		var section = "<section id='section" + (i + 1) + "'>";

		var header = "<header><h1>Fabriquant du " + jsonObject.nomProduit + "</h1><a href='#section1'>Retour a la premiere section</a></header>";
		...
		var footer = "<footer><p>Prix : 500$ <a href='#section" + descJsonObjects.length + "'>Aller a la derniere section</a></p></footer>";
