...
$(document).ready(function() {
	...
	for (var i = 0; i < descJsonObjects.length; i++) {
		...
		if (jsonObject.categorieProduit == "Samsung") {
			...
			var section = "<section id='sectionSamsung" + (i + 1) + "'>";
			...
			var footer = "<footer><p>Prix : 500$ <a href='#sectionSamsung" + descJsonObjects.length + "'>Aller a la derniere section</a></p></footer>";
